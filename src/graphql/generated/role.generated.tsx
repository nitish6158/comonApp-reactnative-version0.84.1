...
export type GetMyRoleQueryVariables = Types.Exact<{
  input: Types.GetMyRole;
}>;
...
export type SetRoleMutationVariables = Types.Exact<{
  input: Types.SetRoleInput;
}>;
...
export function useGetMyRoleQuery(
  ...
  return Apollo.useQuery<GetMyRoleQuery, GetMyRoleQueryVariables>(
    GetMyRoleDocument,
    options
  );
}
export function useGetMyRoleLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetMyRoleQuery,
    GetMyRoleQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetMyRoleQuery, GetMyRoleQueryVariables>(
    GetMyRoleDocument,
    options
  );
}
export type GetMyRoleQueryHookResult = ReturnType<typeof useGetMyRoleQuery>;
export type GetMyRoleLazyQueryHookResult = ReturnType<
  typeof useGetMyRoleLazyQuery
>;
export type GetMyRoleQueryResult = Apollo.QueryResult<
  GetMyRoleQuery,
  GetMyRoleQueryVariables
>;
