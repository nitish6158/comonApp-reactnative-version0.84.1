...
import { PaginatedReportDetailsFragmentDoc } from "./fragments.generated";
...
export type StartReportMutationVariables = Types.Exact<{
  input: Types.StartReportDto;
}>;

export type StartReportMutation = {
  __typename?: "Mutation";
  startReport: {
    __typename?: "Report";
    _id: string;
...
export type AddTaskResultMutationVariables = Types.Exact<{
  input: Types.AddTaskResultDto;
}>;

export type AddTaskResultMutation = {
  __typename?: "Mutation";
  addTaskResult: {
    __typename?: "Report";
    _id: string;
...
export type CompleteReportMutationVariables = Types.Exact<{
  input: Types.CompleteReportsInputDto;
}>;
...
export const MyReportsDocument = gql`
  ...
  ${PaginatedReportDetailsFragmentDoc}
`;
...
export function useMyReportsQuery(
  ...
  return Apollo.useQuery<MyReportsQuery, MyReportsQueryVariables>(
    MyReportsDocument,
    options
  );
}
export function useMyReportsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MyReportsQuery,
    MyReportsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyReportsQuery, MyReportsQueryVariables>(
    MyReportsDocument,
    options
  );
}
export type MyReportsQueryHookResult = ReturnType<typeof useMyReportsQuery>;
export type MyReportsLazyQueryHookResult = ReturnType<
  typeof useMyReportsLazyQuery
>;
export type MyReportsQueryResult = Apollo.QueryResult<
  MyReportsQuery,
  MyReportsQueryVariables
>;
...
>;
export const StartReportDocument = gql`
  ...
  ${ReportDetailsFragmentDoc}
`;
export type StartReportMutationFn = Apollo.MutationFunction<
  StartReportMutation,
  StartReportMutationVariables
>;

/**
 * __useStartReportMutation__
 *
 * To run a mutation, you first call `useStartReportMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useStartReportMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [startReportMutation, { data, loading, error }] = useStartReportMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useStartReportMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<StartReportMutation, StartReportMutationVariables>(
    StartReportDocument,
    options
  );
}
export type StartReportMutationHookResult = ReturnType<
  typeof useStartReportMutation
>;
export type StartReportMutationResult =
  Apollo.MutationResult<StartReportMutation>;
export type StartReportMutationOptions = Apollo.BaseMutationOptions<
  StartReportMutation,
  StartReportMutationVariables
>;
export const AddTaskResultDocument = gql`
  ...
  ${ReportDetailsFragmentDoc}
`;
export type AddTaskResultMutationFn = Apollo.MutationFunction<
  AddTaskResultMutation,
  AddTaskResultMutationVariables
>;

/**
 * __useAddTaskResultMutation__
 *
 * To run a mutation, you first call `useAddTaskResultMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddTaskResultMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addTaskResultMutation, { data, loading, error }] = useAddTaskResultMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddTaskResultMutation(
  baseOptions?: Apollo.MutationHookOptions<
    AddTaskResultMutation,
    AddTaskResultMutationVariables
  >
  ...
  return Apollo.useMutation<
    AddTaskResultMutation,
    AddTaskResultMutationVariables
  >(AddTaskResultDocument, options);
}
export type AddTaskResultMutationHookResult = ReturnType<
  typeof useAddTaskResultMutation
>;
export type AddTaskResultMutationResult =
  Apollo.MutationResult<AddTaskResultMutation>;
export type AddTaskResultMutationOptions = Apollo.BaseMutationOptions<
  AddTaskResultMutation,
  AddTaskResultMutationVariables
>;
export const CompleteReportDocument = gql`
  ...
  ${ReportDetailsFragmentDoc}
`;
export type CompleteReportMutationFn = Apollo.MutationFunction<
  CompleteReportMutation,
  CompleteReportMutationVariables
>;

/**
 * __useCompleteReportMutation__
 *
 * To run a mutation, you first call `useCompleteReportMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCompleteReportMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [completeReportMutation, { data, loading, error }] = useCompleteReportMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCompleteReportMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CompleteReportMutation,
    CompleteReportMutationVariables
  >
  ...
  return Apollo.useMutation<
    CompleteReportMutation,
    CompleteReportMutationVariables
  >(CompleteReportDocument, options);
}
export type CompleteReportMutationHookResult = ReturnType<
  typeof useCompleteReportMutation
>;
export type CompleteReportMutationResult =
  Apollo.MutationResult<CompleteReportMutation>;
export type CompleteReportMutationOptions = Apollo.BaseMutationOptions<
  CompleteReportMutation,
  CompleteReportMutationVariables
>;
