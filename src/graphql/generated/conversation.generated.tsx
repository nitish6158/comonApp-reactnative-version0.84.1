...
export type GetBackgroundMessagesQueryVariables = Types.Exact<{
  input: Types.GetBackgroundMessagesInput;
}>;

export type GetBackgroundMessagesQuery = {
  __typename?: "Query";
  getBackgroundMessages?: Array<{
    __typename?: "ConversationWithIndex";
    _id: string;
    roomId: string;
    type: string;
    ...
    created_at: number;
    receipts: boolean;
    inviteStatus?: Types.Status | null;
    updated_at: number;
    index: number;
    reply_msg?: {
      __typename?: "ReplyMessage";
    ...
    read_by: Array<{ __typename?: "ReadBy"; user_id: string; read_at: number }>;
    favourite_by: Array<{
      __typename?: "FavouriteBy";
      user_id: string;
      favourite_at: number;
    ...
    PinBy: Array<{ __typename?: "PinBy"; user_id: string; pin_at: number }>;
    delivered_to: Array<{
      __typename?: "DeliveredTo";
      user_id: string;
      delivered_at: number;
...
export type GetDeliveredReadDataByMessageIdQueryVariables = Types.Exact<{
  input: Types.GetDeliveredReadInput;
}>;

export type GetDeliveredReadDataByMessageIdQuery = {
  __typename?: "Query";
  getDeliveredReadDataByMessageId?: {
    __typename?: "GetDeliveredAndReadResponse";
    delivered_to?: Array<{
      __typename?: "DeliveredToType";
      user_id: string;
...
export const GetBackgroundMessagesDocument = gql`
...
`;
/**
 * __useGetBackgroundMessagesQuery__
 *
 * To run a query within a React component, call `useGetBackgroundMessagesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBackgroundMessagesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBackgroundMessagesQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetBackgroundMessagesQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetBackgroundMessagesQuery,
    GetBackgroundMessagesQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetBackgroundMessagesQuery,
    GetBackgroundMessagesQueryVariables
  >(GetBackgroundMessagesDocument, options);
}
export function useGetBackgroundMessagesLazyQuery(
...
export type GetBackgroundMessagesQueryHookResult = ReturnType<
  typeof useGetBackgroundMessagesQuery
>;
export type GetBackgroundMessagesLazyQueryHookResult = ReturnType<
  typeof useGetBackgroundMessagesLazyQuery
>;
export type GetBackgroundMessagesQueryResult = Apollo.QueryResult<
  GetBackgroundMessagesQuery,
  GetBackgroundMessagesQueryVariables
>;
export const GetDeliveredReadDataByMessageIdDocument = gql`
...
/**
 * __useGetDeliveredReadDataByMessageIdQuery__
 *
 * To run a query within a React component, call `useGetDeliveredReadDataByMessageIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetDeliveredReadDataByMessageIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetDeliveredReadDataByMessageIdQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetDeliveredReadDataByMessageIdQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDeliveredReadDataByMessageIdQuery,
    GetDeliveredReadDataByMessageIdQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetDeliveredReadDataByMessageIdQuery,
    GetDeliveredReadDataByMessageIdQueryVariables
  >(GetDeliveredReadDataByMessageIdDocument, options);
}
export function useGetDeliveredReadDataByMessageIdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDeliveredReadDataByMessageIdQuery,
    GetDeliveredReadDataByMessageIdQueryVariables
  >
...
export type GetDeliveredReadDataByMessageIdQueryHookResult = ReturnType<
  typeof useGetDeliveredReadDataByMessageIdQuery
>;
export type GetDeliveredReadDataByMessageIdLazyQueryHookResult = ReturnType<
  typeof useGetDeliveredReadDataByMessageIdLazyQuery
>;
export type GetDeliveredReadDataByMessageIdQueryResult = Apollo.QueryResult<
  GetDeliveredReadDataByMessageIdQuery,
  GetDeliveredReadDataByMessageIdQueryVariables
>;
