...
import { PositionDetailsFragmentDoc } from "./position.generated";
import { EdgeDetailsFragmentDoc } from "./fragments.generated";
import { ReportDetailsFragmentDoc } from "./fragments.generated";
...
export type Task_DetailsFragment = {
  __typename: "Task";
  _id: string;
  label: string;
  address?: string | null;
  ...
  mediaQuality: Types.MediaQuality;
  mediaDuration?: number | null;
  saveUserLocation: boolean;
  width?: number | null;
  isPostponeApproval?: boolean | null;
  ...
  notifyTo?: Array<{
    __typename: "NotifyTo";
    message?: string | null;
    member?: { __typename: "Member"; _id: string } | null;
  }> | null;
  rangeExpression?: {
    __typename: "RangeExpression";
    min?: number | null;
  ...
  attachment?: {
    __typename: "Attachment";
    type?: Types.AttachmentType | null;
    attachment?: {
      __typename: "StorageItem";
      _id: string;
      filename: string;
...
export type StartTaskMutationVariables = Types.Exact<{
  input: Types.StartTaskDto;
}>;
...
export type UploadFileMutation = {
  __typename?: "Mutation";
  uploadFile: { __typename?: "StorageItem"; _id: string };
};

export type GetMyNotificationsQueryVariables = Types.Exact<{
  input: Types.MyNotificationsInput;
}>;
...
export type SetNotificationSeenMutationVariables = Types.Exact<{
  input: Types.NotificationSeen;
}>;

export type SetNotificationSeenMutation = {
  __typename?: "Mutation";
  setNotificationSeen: {
    __typename?: "BasicResponce";
    success: boolean;
...
export type CheckIsValidDateMutationVariables = Types.Exact<{
  input: Types.CurrentTimeInput;
}>;

export type CheckIsValidDateMutation = {
  __typename?: "Mutation";
  checkIsValidDate: {
    __typename?: "CheckValidDateResponse";
...
export type UpdateEdgeMutationVariables = Types.Exact<{
  input: Types.UpdateEdgeDto;
}>;
...
export const Task_DetailsFragmentDoc = gql`
...
export type StartTaskMutationHookResult = ReturnType<
  typeof useStartTaskMutation
>;
...
`;
export type SetNotificationSeenMutationFn = Apollo.MutationFunction<
  SetNotificationSeenMutation,
  SetNotificationSeenMutationVariables
>;
 ...
 * });
 */
export function useSetNotificationSeenMutation(
  baseOptions?: Apollo.MutationHookOptions<
    SetNotificationSeenMutation,
    SetNotificationSeenMutationVariables
  >,
  ...
  return Apollo.useMutation<
    SetNotificationSeenMutation,
    SetNotificationSeenMutationVariables
  >(SetNotificationSeenDocument, options);
}
export type SetNotificationSeenMutationHookResult = ReturnType<
  typeof useSetNotificationSeenMutation
>;
export type SetNotificationSeenMutationResult =
  Apollo.MutationResult<SetNotificationSeenMutation>;
export type SetNotificationSeenMutationOptions = Apollo.BaseMutationOptions<
  SetNotificationSeenMutation,
  SetNotificationSeenMutationVariables
>;
export const CheckIsValidDateDocument = gql`
...
`;
export type CheckIsValidDateMutationFn = Apollo.MutationFunction<
  CheckIsValidDateMutation,
  CheckIsValidDateMutationVariables
>;

/**
 * __useCheckIsValidDateMutation__
 *
 * To run a mutation, you first call `useCheckIsValidDateMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCheckIsValidDateMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [checkIsValidDateMutation, { data, loading, error }] = useCheckIsValidDateMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCheckIsValidDateMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CheckIsValidDateMutation,
    CheckIsValidDateMutationVariables
  >,
  ...
  return Apollo.useMutation<
    CheckIsValidDateMutation,
    CheckIsValidDateMutationVariables
  >(CheckIsValidDateDocument, options);
}
export type CheckIsValidDateMutationHookResult = ReturnType<
  typeof useCheckIsValidDateMutation
>;
export type CheckIsValidDateMutationResult =
  Apollo.MutationResult<CheckIsValidDateMutation>;
export type CheckIsValidDateMutationOptions = Apollo.BaseMutationOptions<
  CheckIsValidDateMutation,
  CheckIsValidDateMutationVariables
>;
...
>;
export type UpdateEdgeMutationResult =
  Apollo.MutationResult<UpdateEdgeMutation>;
