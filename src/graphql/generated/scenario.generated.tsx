...
import { TaskDetailsFragmentDoc } from "./fragments.generated";
...
export type ScenarioTaskDetailsFragment = {
  __typename: "Task";
  _id: string;
  label: string;
  address?: string | null;
...
export type ScenarioDetailsFragment = {
  __typename?: "Scenario";
  _id: string;
  name: string;
...
export type ScenarioQueryVariables = Types.Exact<{
  input: Types.OrgAndIdDto;
}>;
...
export type BasicResponceDetailsFragment = {
  __typename?: "BasicResponce";
  success: boolean;
  message?: string | null;
};

export type ValidateScenarioNameQueryVariables = Types.Exact<{
  input: Types.ValidateScenarioNameDto;
}>;

export type ValidateScenarioNameQuery = {
  __typename?: "Query";
...
export type Scenario_DetailsFragment = {
  __typename: "Scenario";
  _id: string;
  name: string;
  description?: string | null;
...
export const ScenarioDetailsFragmentDoc = gql`
...
`;
export const BasicResponceDetailsFragmentDoc = gql`
  fragment BasicResponceDetails on BasicResponce {
    success
    message
  }
`;
export const ScenarioTaskDetailsFragmentDoc = gql`
  fragment ScenarioTaskDetails on Task {
    _id
    label
    address
    lat
...
`;
export const Scenario_DetailsFragmentDoc = gql`
  fragment Scenario_Details on Scenario {
    _id
    name
    description
    organizationId
  ...
  ${ScenarioTaskDetailsFragmentDoc}
`;
...
export type ScenarioQueryResult = Apollo.QueryResult<
  ...
  ScenarioQueryVariables
>;
export const ValidateScenarioNameDocument = gql`
  query ValidateScenarioName($input: ValidateScenarioNameDto!) {
    validateScenarioName(input: $input) {
      ...BasicResponceDetails
    }
  }
  ${BasicResponceDetailsFragmentDoc}
`;

/**
 * __useValidateScenarioNameQuery__
 *
 * To run a query within a React component, call `useValidateScenarioNameQuery` and pass it any options that fit your needs.
 * When your component renders, `useValidateScenarioNameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useValidateScenarioNameQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useValidateScenarioNameQuery(
  baseOptions: Apollo.QueryHookOptions<
    ValidateScenarioNameQuery,
    ValidateScenarioNameQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    ValidateScenarioNameQuery,
    ValidateScenarioNameQueryVariables
  >(ValidateScenarioNameDocument, options);
}
export function useValidateScenarioNameLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ValidateScenarioNameQuery,
    ValidateScenarioNameQueryVariables
  >,
...
export type ValidateScenarioNameQueryHookResult = ReturnType<
  typeof useValidateScenarioNameQuery
>;
export type ValidateScenarioNameLazyQueryHookResult = ReturnType<
  typeof useValidateScenarioNameLazyQuery
>;
export type ValidateScenarioNameQueryResult = Apollo.QueryResult<
  ValidateScenarioNameQuery,
  ValidateScenarioNameQueryVariables
>;
export const CreateScenarioDocument = gql`
  mutation createScenario($input: CreateScenarioDto!) {
    createScenario(input: $input) {
      ...Scenario_Details
      __typename
    }
  }
  ${Scenario_DetailsFragmentDoc}
`;
...
export const UpdateScenarioDocument = gql`
  mutation updateScenario($input: UpdateScenarioDto!) {
