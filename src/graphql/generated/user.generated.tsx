...
export type UserDataFragment = {
  ...
  visibility?: Types.UserAvailability | null;
  mode: Types.UserModeStatus;
  ...
  seniorCitizenRoom: Array<{
    __typename?: "seniorCitizenRoomSchema";
    roomId?: string | null;
    userId?: string | null;
  }>;
  bio: { __typename?: "Bio"; status?: string | null; time?: number | null };
  blockedRooms: Array<{
    __typename?: "BlockedRoom";
    room_Id: string;
    pid: string;
  ...
  contact_reminder?: Array<{
    ...
    frequency: Types.OnlineStatusFrequency;
    onlineTime?: string | null;
  }> | null;
  globalFrequency: {
    __typename?: "GlobalFrequencyUnitSchema";
    Count: number;
    Unit: Types.GlobalFrequencyUnit;
  };
  device?: {
    __typename?: "deviceInfo";
    token: string;
  ...
  lastSynced: { __typename?: "LastSynced"; contactList: any };
};
...
export type UserDetailsFragment = {
  ...
  emailConfirmed: boolean;
  _id: string;
  device?: { __typename?: "deviceInfo"; token: string; type: string } | null;
};

export type GetLanguageListQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetLanguageListQuery = {
  __typename?: "Query";
...
export type UpdateUserLanguageMutationVariables = Types.Exact<{
  input: Types.UpdateUserLanguageInput;
}>;
...
export type GetByIdsQueryVariables = Types.Exact<{
  input: Types.UserIdsInputDto;
}>;
...
export type UpdateUserModeMutationVariables = Types.Exact<{
  input: Types.UpdateModeInput;
}>;

export type UpdateUserModeMutation = {
  __typename?: "Mutation";
  updateUserMode?: {
    __typename?: "User";
    _id: string;
...
export type UpdateRoomListSeniorMutationVariables = Types.Exact<{
  input: Types.SeniorModeRoomSelectionInput;
}>;

export type UpdateRoomListSeniorMutation = {
  __typename?: "Mutation";
  updateRoomListSenior?: {
    __typename?: "BasicResponce";
    success: boolean;
  } | null;
};

export type GetContactRemindersQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetContactRemindersQuery = {
  __typename?: "Query";
  getContactReminders: Array<{
    __typename?: "UserContact";
    _id: string;
    firstName: string;
    lastName: string;
...
export type CreateContactReminderMutationVariables = Types.Exact<{
  input: Types.CreateContactReminderInput;
}>;

export type CreateContactReminderMutation = {
  __typename?: "Mutation";
...
export type RemoveContactReminderMutationVariables = Types.Exact<{
  input: Types.IdDto;
}>;

export type RemoveContactReminderMutation = {
  __typename?: "Mutation";
...
export type UpdateGlobalReminderMutationVariables = Types.Exact<{
  input: Types.GlobalFrequencyUnitInput;
}>;

export type UpdateGlobalReminderMutation = {
  __typename?: "Mutation";
...
export type UpdateContactReminderMutationVariables = Types.Exact<{
  input: Types.CreateContactReminderInput;
}>;

export type UpdateContactReminderMutation = {
  __typename?: "Mutation";
...
export type UpdateUserAvailabilityMutationVariables = Types.Exact<{
  input: Types.UpdateUserAvailabilityInput;
}>;
...
export type UpdateDismissMutationVariables = Types.Exact<{
  input: Types.UpdateDisMissInput;
}>;

export type UpdateDismissMutation = {
  __typename?: "Mutation";
  updateDismiss: {
    __typename?: "User";
    _id: string;
 ...
 * });
 */
export function useGetLanguageListQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetLanguageListQuery,
    GetLanguageListQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetLanguageListQuery, GetLanguageListQueryVariables>(
    GetLanguageListDocument,
    options
  );
}
export function useGetLanguageListLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetLanguageListQuery,
    GetLanguageListQueryVariables
  >(GetLanguageListDocument, options);
}
export type GetLanguageListQueryHookResult = ReturnType<
  typeof useGetLanguageListQuery
>;
export type GetLanguageListLazyQueryHookResult = ReturnType<
  typeof useGetLanguageListLazyQuery
>;
export type GetLanguageListQueryResult = Apollo.QueryResult<
  GetLanguageListQuery,
  GetLanguageListQueryVariables
>;
...
export type UpdateUserMutationOptions = Apollo.BaseMutationOptions<
  ...
  UpdateUserMutationVariables
>;
export const GetByIdsDocument = gql`
...
/**
 * __useGetByIdsQuery__
 *
 * To run a query within a React component, call `useGetByIdsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetByIdsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetByIdsQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetByIdsQuery(
  baseOptions: Apollo.QueryHookOptions<GetByIdsQuery, GetByIdsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetByIdsQuery, GetByIdsQueryVariables>(
    GetByIdsDocument,
    options
  );
}
export function useGetByIdsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetByIdsQuery,
    GetByIdsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetByIdsQuery, GetByIdsQueryVariables>(
    GetByIdsDocument,
    options
  );
}
export type GetByIdsQueryHookResult = ReturnType<typeof useGetByIdsQuery>;
export type GetByIdsLazyQueryHookResult = ReturnType<
  typeof useGetByIdsLazyQuery
>;
export type GetByIdsQueryResult = Apollo.QueryResult<
  GetByIdsQuery,
  GetByIdsQueryVariables
>;
export const UpdateUserModeDocument = gql`
  ...
  ${UserDataFragmentDoc}
`;
export type UpdateUserModeMutationFn = Apollo.MutationFunction<
  UpdateUserModeMutation,
  UpdateUserModeMutationVariables
>;

/**
 * __useUpdateUserModeMutation__
 *
 * To run a mutation, you first call `useUpdateUserModeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateUserModeMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateUserModeMutation, { data, loading, error }] = useUpdateUserModeMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateUserModeMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateUserModeMutation,
    UpdateUserModeMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateUserModeMutation,
    UpdateUserModeMutationVariables
  >(UpdateUserModeDocument, options);
}
export type UpdateUserModeMutationHookResult = ReturnType<
  typeof useUpdateUserModeMutation
>;
export type UpdateUserModeMutationResult =
  Apollo.MutationResult<UpdateUserModeMutation>;
export type UpdateUserModeMutationOptions = Apollo.BaseMutationOptions<
  UpdateUserModeMutation,
  UpdateUserModeMutationVariables
>;
export const UpdateRoomListSeniorDocument = gql`
...
`;
export type UpdateRoomListSeniorMutationFn = Apollo.MutationFunction<
  UpdateRoomListSeniorMutation,
  UpdateRoomListSeniorMutationVariables
>;

/**
 * __useUpdateRoomListSeniorMutation__
 *
 * To run a mutation, you first call `useUpdateRoomListSeniorMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateRoomListSeniorMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateRoomListSeniorMutation, { data, loading, error }] = useUpdateRoomListSeniorMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateRoomListSeniorMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateRoomListSeniorMutation,
    UpdateRoomListSeniorMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateRoomListSeniorMutation,
    UpdateRoomListSeniorMutationVariables
  >(UpdateRoomListSeniorDocument, options);
}
export type UpdateRoomListSeniorMutationHookResult = ReturnType<
  typeof useUpdateRoomListSeniorMutation
>;
export type UpdateRoomListSeniorMutationResult =
  Apollo.MutationResult<UpdateRoomListSeniorMutation>;
export type UpdateRoomListSeniorMutationOptions = Apollo.BaseMutationOptions<
  UpdateRoomListSeniorMutation,
  UpdateRoomListSeniorMutationVariables
>;
export const GetContactRemindersDocument = gql`
...
/**
 * __useGetContactRemindersQuery__
 *
 * To run a query within a React component, call `useGetContactRemindersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetContactRemindersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetContactRemindersQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetContactRemindersQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetContactRemindersQuery,
    GetContactRemindersQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetContactRemindersQuery,
    GetContactRemindersQueryVariables
  >(GetContactRemindersDocument, options);
}
export function useGetContactRemindersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetContactRemindersQuery,
    GetContactRemindersQueryVariables
  >
...
export type GetContactRemindersQueryHookResult = ReturnType<
  typeof useGetContactRemindersQuery
>;
export type GetContactRemindersLazyQueryHookResult = ReturnType<
  typeof useGetContactRemindersLazyQuery
>;
export type GetContactRemindersQueryResult = Apollo.QueryResult<
  GetContactRemindersQuery,
  GetContactRemindersQueryVariables
>;
export const CreateContactReminderDocument = gql`
  ...
  ${UserDataFragmentDoc}
`;
export type CreateContactReminderMutationFn = Apollo.MutationFunction<
  CreateContactReminderMutation,
  CreateContactReminderMutationVariables
>;

/**
 * __useCreateContactReminderMutation__
 *
 * To run a mutation, you first call `useCreateContactReminderMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateContactReminderMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createContactReminderMutation, { data, loading, error }] = useCreateContactReminderMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateContactReminderMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateContactReminderMutation,
    CreateContactReminderMutationVariables
  >
  ...
  return Apollo.useMutation<
    CreateContactReminderMutation,
    CreateContactReminderMutationVariables
  >(CreateContactReminderDocument, options);
}
export type CreateContactReminderMutationHookResult = ReturnType<
  typeof useCreateContactReminderMutation
>;
export type CreateContactReminderMutationResult =
  Apollo.MutationResult<CreateContactReminderMutation>;
export type CreateContactReminderMutationOptions = Apollo.BaseMutationOptions<
  CreateContactReminderMutation,
  CreateContactReminderMutationVariables
>;
export const RemoveContactReminderDocument = gql`
  ...
  ${UserDataFragmentDoc}
`;
export type RemoveContactReminderMutationFn = Apollo.MutationFunction<
  RemoveContactReminderMutation,
  RemoveContactReminderMutationVariables
>;

/**
 * __useRemoveContactReminderMutation__
 *
 * To run a mutation, you first call `useRemoveContactReminderMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRemoveContactReminderMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [removeContactReminderMutation, { data, loading, error }] = useRemoveContactReminderMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useRemoveContactReminderMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RemoveContactReminderMutation,
    RemoveContactReminderMutationVariables
  >
  ...
  return Apollo.useMutation<
    RemoveContactReminderMutation,
    RemoveContactReminderMutationVariables
  >(RemoveContactReminderDocument, options);
}
export type RemoveContactReminderMutationHookResult = ReturnType<
  typeof useRemoveContactReminderMutation
>;
export type RemoveContactReminderMutationResult =
  Apollo.MutationResult<RemoveContactReminderMutation>;
export type RemoveContactReminderMutationOptions = Apollo.BaseMutationOptions<
  RemoveContactReminderMutation,
  RemoveContactReminderMutationVariables
>;
export const UpdateGlobalReminderDocument = gql`
  ...
  ${UserDataFragmentDoc}
`;
export type UpdateGlobalReminderMutationFn = Apollo.MutationFunction<
  UpdateGlobalReminderMutation,
  UpdateGlobalReminderMutationVariables
>;

/**
 * __useUpdateGlobalReminderMutation__
 *
 * To run a mutation, you first call `useUpdateGlobalReminderMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateGlobalReminderMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateGlobalReminderMutation, { data, loading, error }] = useUpdateGlobalReminderMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateGlobalReminderMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateGlobalReminderMutation,
    UpdateGlobalReminderMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateGlobalReminderMutation,
    UpdateGlobalReminderMutationVariables
  >(UpdateGlobalReminderDocument, options);
}
export type UpdateGlobalReminderMutationHookResult = ReturnType<
  typeof useUpdateGlobalReminderMutation
>;
export type UpdateGlobalReminderMutationResult =
  Apollo.MutationResult<UpdateGlobalReminderMutation>;
export type UpdateGlobalReminderMutationOptions = Apollo.BaseMutationOptions<
  UpdateGlobalReminderMutation,
  UpdateGlobalReminderMutationVariables
>;
export const UpdateContactReminderDocument = gql`
  ...
  ${UserDataFragmentDoc}
`;
export type UpdateContactReminderMutationFn = Apollo.MutationFunction<
  UpdateContactReminderMutation,
  UpdateContactReminderMutationVariables
>;

/**
 * __useUpdateContactReminderMutation__
 *
 * To run a mutation, you first call `useUpdateContactReminderMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateContactReminderMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateContactReminderMutation, { data, loading, error }] = useUpdateContactReminderMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateContactReminderMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateContactReminderMutation,
    UpdateContactReminderMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateContactReminderMutation,
    UpdateContactReminderMutationVariables
  >(UpdateContactReminderDocument, options);
}
export type UpdateContactReminderMutationHookResult = ReturnType<
  typeof useUpdateContactReminderMutation
>;
export type UpdateContactReminderMutationResult =
  Apollo.MutationResult<UpdateContactReminderMutation>;
export type UpdateContactReminderMutationOptions = Apollo.BaseMutationOptions<
  UpdateContactReminderMutation,
  UpdateContactReminderMutationVariables
>;
export const UpdateUserAvailabilityDocument = gql`
  ...
  ${UserDataFragmentDoc}
`;
export type UpdateUserAvailabilityMutationFn = Apollo.MutationFunction<
  UpdateUserAvailabilityMutation,
  UpdateUserAvailabilityMutationVariables
>;

/**
 * __useUpdateUserAvailabilityMutation__
 *
 * To run a mutation, you first call `useUpdateUserAvailabilityMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateUserAvailabilityMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateUserAvailabilityMutation, { data, loading, error }] = useUpdateUserAvailabilityMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateUserAvailabilityMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateUserAvailabilityMutation,
    UpdateUserAvailabilityMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateUserAvailabilityMutation,
    UpdateUserAvailabilityMutationVariables
  >(UpdateUserAvailabilityDocument, options);
}
export type UpdateUserAvailabilityMutationHookResult = ReturnType<
  typeof useUpdateUserAvailabilityMutation
>;
export type UpdateUserAvailabilityMutationResult =
  Apollo.MutationResult<UpdateUserAvailabilityMutation>;
export type UpdateUserAvailabilityMutationOptions = Apollo.BaseMutationOptions<
  UpdateUserAvailabilityMutation,
  UpdateUserAvailabilityMutationVariables
>;
export const UpdateDismissDocument = gql`
  ...
  ${UserDataFragmentDoc}
`;
export type UpdateDismissMutationFn = Apollo.MutationFunction<
  UpdateDismissMutation,
  UpdateDismissMutationVariables
>;

/**
 * __useUpdateDismissMutation__
 *
 * To run a mutation, you first call `useUpdateDismissMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateDismissMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateDismissMutation, { data, loading, error }] = useUpdateDismissMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateDismissMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateDismissMutation,
    UpdateDismissMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateDismissMutation,
    UpdateDismissMutationVariables
  >(UpdateDismissDocument, options);
}
export type UpdateDismissMutationHookResult = ReturnType<
  typeof useUpdateDismissMutation
>;
export type UpdateDismissMutationResult =
  Apollo.MutationResult<UpdateDismissMutation>;
export type UpdateDismissMutationOptions = Apollo.BaseMutationOptions<
  UpdateDismissMutation,
  UpdateDismissMutationVariables
>;
...
export function useGetNotificationByIdQuery(
  ...
  return Apollo.useQuery<
    GetNotificationByIdQuery,
    GetNotificationByIdQueryVariables
  >(GetNotificationByIdDocument, options);
}
...
export type GetNotificationByIdQueryHookResult = ReturnType<
  typeof useGetNotificationByIdQuery
>;
