...
export type TakeSurveyMutationVariables = Types.Exact<{
  input: Types.SurveyDateTimeInput;
}>;

export type TakeSurveyMutation = {
  __typename?: "Mutation";
  takeSurvey: {
    __typename?: "BasicResponceSurvey";
    message?: string | null;
...
export type ConductSurveyQueryVariables = Types.Exact<{
  input: Types.IdDto;
}>;

export type ConductSurveyQuery = {
  __typename?: "Query";
  conductSurvey: {
    __typename?: "adminSurveyResponse";
    Module?: Types.SurveyEventType | null;
    scenario?: Array<{
      __typename?: "surveyScenario";
...
export type CreateSurveyAnswerMutationVariables = Types.Exact<{
  input: Types.SurveyAnswersInput;
}>;

export type CreateSurveyAnswerMutation = {
  __typename?: "Mutation";
  createSurveyAnswer: {
    __typename?: "BasicResponce";
    success: boolean;
...
export type UpdateUserIsSurveyMutationVariables = Types.Exact<{
  input: Types.IsSurveyNeed;
}>;

export type UpdateUserIsSurveyMutation = {
  __typename?: "Mutation";
  updateUserIsSurvey: {
    __typename?: "BasicResponce";
    success: boolean;
...
export const TakeSurveyDocument = gql`
...
`;
export type TakeSurveyMutationFn = Apollo.MutationFunction<
  TakeSurveyMutation,
  TakeSurveyMutationVariables
>;

/**
 * __useTakeSurveyMutation__
 *
 * To run a mutation, you first call `useTakeSurveyMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useTakeSurveyMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [takeSurveyMutation, { data, loading, error }] = useTakeSurveyMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useTakeSurveyMutation(
  ...
  return Apollo.useMutation<TakeSurveyMutation, TakeSurveyMutationVariables>(
    TakeSurveyDocument,
    options
  );
}
export type TakeSurveyMutationHookResult = ReturnType<
  typeof useTakeSurveyMutation
>;
export type TakeSurveyMutationResult =
  Apollo.MutationResult<TakeSurveyMutation>;
export type TakeSurveyMutationOptions = Apollo.BaseMutationOptions<
  TakeSurveyMutation,
  TakeSurveyMutationVariables
>;
export const ConductSurveyDocument = gql`
...
/**
 * __useConductSurveyQuery__
 *
 * To run a query within a React component, call `useConductSurveyQuery` and pass it any options that fit your needs.
 * When your component renders, `useConductSurveyQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useConductSurveyQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useConductSurveyQuery(
  baseOptions: Apollo.QueryHookOptions<
    ConductSurveyQuery,
    ConductSurveyQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ConductSurveyQuery, ConductSurveyQueryVariables>(
    ConductSurveyDocument,
    options
  );
}
export function useConductSurveyLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ConductSurveyQuery, ConductSurveyQueryVariables>(
    ConductSurveyDocument,
    options
  );
}
export type ConductSurveyQueryHookResult = ReturnType<
  typeof useConductSurveyQuery
>;
export type ConductSurveyLazyQueryHookResult = ReturnType<
  typeof useConductSurveyLazyQuery
>;
export type ConductSurveyQueryResult = Apollo.QueryResult<
  ConductSurveyQuery,
  ConductSurveyQueryVariables
>;
export const CreateSurveyAnswerDocument = gql`
...
`;
export type CreateSurveyAnswerMutationFn = Apollo.MutationFunction<
  CreateSurveyAnswerMutation,
  CreateSurveyAnswerMutationVariables
>;

/**
 * __useCreateSurveyAnswerMutation__
 *
 * To run a mutation, you first call `useCreateSurveyAnswerMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSurveyAnswerMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createSurveyAnswerMutation, { data, loading, error }] = useCreateSurveyAnswerMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateSurveyAnswerMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateSurveyAnswerMutation,
    CreateSurveyAnswerMutationVariables
  >
  ...
  return Apollo.useMutation<
    CreateSurveyAnswerMutation,
    CreateSurveyAnswerMutationVariables
  >(CreateSurveyAnswerDocument, options);
}
export type CreateSurveyAnswerMutationHookResult = ReturnType<
  typeof useCreateSurveyAnswerMutation
>;
export type CreateSurveyAnswerMutationResult =
  Apollo.MutationResult<CreateSurveyAnswerMutation>;
export type CreateSurveyAnswerMutationOptions = Apollo.BaseMutationOptions<
  CreateSurveyAnswerMutation,
  CreateSurveyAnswerMutationVariables
>;
export const UpdateUserIsSurveyDocument = gql`
...
`;
export type UpdateUserIsSurveyMutationFn = Apollo.MutationFunction<
  UpdateUserIsSurveyMutation,
  UpdateUserIsSurveyMutationVariables
>;

/**
 * __useUpdateUserIsSurveyMutation__
 *
 * To run a mutation, you first call `useUpdateUserIsSurveyMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateUserIsSurveyMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateUserIsSurveyMutation, { data, loading, error }] = useUpdateUserIsSurveyMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateUserIsSurveyMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateUserIsSurveyMutation,
    UpdateUserIsSurveyMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateUserIsSurveyMutation,
    UpdateUserIsSurveyMutationVariables
  >(UpdateUserIsSurveyDocument, options);
}
export type UpdateUserIsSurveyMutationHookResult = ReturnType<
  typeof useUpdateUserIsSurveyMutation
>;
export type UpdateUserIsSurveyMutationResult =
  Apollo.MutationResult<UpdateUserIsSurveyMutation>;
export type UpdateUserIsSurveyMutationOptions = Apollo.BaseMutationOptions<
  UpdateUserIsSurveyMutation,
  UpdateUserIsSurveyMutationVariables
>;
