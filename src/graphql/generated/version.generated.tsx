...
export type GetVersionDetailsQueryVariables = Types.Exact<{
  input: Types.VersionManagementInputDto;
}>;

export type GetVersionDetailsQuery = {
  __typename?: "Query";
  getVersionDetails: {
    __typename?: "versionManagement";
    ...
    expiredVersion: Array<string>;
  };
};

export const GetVersionDetailsDocument = gql`
...
/**
 * __useGetVersionDetailsQuery__
 *
 * To run a query within a React component, call `useGetVersionDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetVersionDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetVersionDetailsQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetVersionDetailsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetVersionDetailsQuery,
    GetVersionDetailsQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetVersionDetailsQuery,
    GetVersionDetailsQueryVariables
  >(GetVersionDetailsDocument, options);
}
export function useGetVersionDetailsLazyQuery(
...
export type GetVersionDetailsQueryHookResult = ReturnType<
  typeof useGetVersionDetailsQuery
>;
export type GetVersionDetailsLazyQueryHookResult = ReturnType<
  typeof useGetVersionDetailsLazyQuery
>;
export type GetVersionDetailsQueryResult = Apollo.QueryResult<
  GetVersionDetailsQuery,
  GetVersionDetailsQueryVariables
>;
