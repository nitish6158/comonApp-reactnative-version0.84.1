...
export type CreateCallMutationVariables = Types.Exact<{
  input: Types.CreateCallDto;
}>;
...
export type CallListenerSubscriptionVariables = Types.Exact<{
  [key: string]: never;
}>;

export type CallListenerSubscription = {
  __typename?: "Subscription";
  callListener: {
    __typename?: "Call";
    _id: string;
...
export type GetRtmTokenMutationVariables = Types.Exact<{
  input: Types.CreateRtmTokenDto;
}>;

export type GetRtmTokenMutation = {
  __typename?: "Mutation";
  getRtmToken: { __typename?: "RtmToken"; token: string };
};

export type ChangeCallStatusMutationVariables = Types.Exact<{
  input: Types.CallStatusChangeDto;
}>;

export type ChangeCallStatusMutation = {
  __typename?: "Mutation";
  changeCallStatus: {
    __typename?: "callStatusChanged";
    callId: string;
...
export type EndCallMutationVariables = Types.Exact<{
  input: Types.EndCallInputDto;
}>;

export type EndCallMutation = {
  __typename?: "Mutation";
  endCall: { __typename?: "callEndedResponse"; time: number; status: string };
};

export type LeftCallMutationVariables = Types.Exact<{
  input: Types.IdDto;
}>;

export type LeftCallMutation = {
  __typename?: "Mutation";
  leftCall: { __typename?: "callEndedResponse"; time: number; status: string };
};

export type CallListQueryVariables = Types.Exact<{
  input: Types.GetCallListDto;
}>;
...
export type GetCallListWithAParticipantQueryVariables = Types.Exact<{
  input: Types.CallListWithAParticipantDto;
}>;

export type GetCallListWithAParticipantQuery = {
  __typename?: "Query";
  getCallListWithAParticipant: Array<{
    __typename?: "CallWithParticipant";
    _id: string;
    channelName: string;
    type: string;
    ...
    origin: { __typename?: "User"; _id: string };
    callParticipants: Array<{
      __typename?: "participantTypes";
      createdAt: any;
      callStatus: string;
      ...
      callHistory: Array<{
        __typename?: "CallHistories";
        callEndedAt?: number | null;
        callJoinedAt?: number | null;
      }>;
    }>;
  }>;
};

export type AcceptRejectVideoRequestMutationVariables = Types.Exact<{
  input: Types.CallTypeChangeDto;
}>;

export type AcceptRejectVideoRequestMutation = {
  __typename?: "Mutation";
  acceptRejectVideoRequest: {
    __typename?: "requestVideoCallResponse";
    status: string;
  };
};

export type RequestVideoCallMutationVariables = Types.Exact<{
  input: Types.RequestVideoCallDto;
}>;

export type RequestVideoCallMutation = {
  __typename?: "Mutation";
  requestVideoCall: { __typename?: "requestVideoCallResponse"; status: string };
};

export type CallWaitingMutationVariables = Types.Exact<{
  input: Types.IdDto;
}>;

export type CallWaitingMutation = {
  __typename?: "Mutation";
  callWaiting: {
    __typename?: "BasicResponce";
    success: boolean;
...
export type GetParticipantsFromContactQueryVariables = Types.Exact<{
  input: Types.IdDto;
}>;

export type GetParticipantsFromContactQuery = {
  __typename?: "Query";
  getParticipantsFromContact?: Array<{
    __typename?: "ParticipantsFromContact";
    _id?: string | null;
    profile_img?: string | null;
    uid?: string | null;
...
export type GetMyCallListQueryVariables = Types.Exact<{
  input: Types.GetMyCallListDto;
}>;

export type GetMyCallListQuery = {
  __typename?: "Query";
  getMyCallList?: Array<{
    __typename?: "myCallListReponse";
    count: number;
...
export type AddParticipantsMutationVariables = Types.Exact<{
  input: Types.AddParticipantsDto;
}>;
...
export type GetOnGoingCallsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetOnGoingCallsQuery = {
  __typename?: "Query";
  getOnGoingCalls?: Array<{
    __typename?: "OnGoingCallResponse";
    _id: string;
    type: string;
    channelName: string;
...
export type CreateNewCallMutationVariables = Types.Exact<{
  input: Types.CreateCallDto;
}>;

export type CreateNewCallMutation = {
  __typename?: "Mutation";
  createNewCall: {
    __typename?: "CallWithToken";
    token: string;
...
export type GetJoinedOnGoingCallsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetJoinedOnGoingCallsQuery = {
  __typename?: "Query";
  getJoinedOnGoingCalls?: Array<{
    __typename?: "OnGoingCallResponse";
    _id: string;
    type: string;
    channelName: string;
...
export type GetChannelStatusQueryVariables = Types.Exact<{
  input: Types.ChannelStatusInput;
}>;

export type GetChannelStatusQuery = {
  __typename?: "Query";
  getChannelStatus?: {
    __typename?: "getChannelStatusDto";
    isChannelExists: string;
...
export type CreateCallMutationHookResult = ReturnType<
  typeof useCreateCallMutation
>;
export type CreateCallMutationResult =
  Apollo.MutationResult<CreateCallMutation>;
...
/**
 * __useCallListenerSubscription__
 *
 * To run a query within a React component, call `useCallListenerSubscription` and pass it any options that fit your needs.
 * When your component renders, `useCallListenerSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCallListenerSubscription({
 *   variables: {
 *   },
 * });
 */
export function useCallListenerSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
    CallListenerSubscription,
    CallListenerSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<
    CallListenerSubscription,
    CallListenerSubscriptionVariables
  >(CallListenerDocument, options);
}
export type CallListenerSubscriptionHookResult = ReturnType<
  typeof useCallListenerSubscription
>;
export type CallListenerSubscriptionResult =
  Apollo.SubscriptionResult<CallListenerSubscription>;
...
`;
export type GetRtmTokenMutationFn = Apollo.MutationFunction<
  GetRtmTokenMutation,
  GetRtmTokenMutationVariables
>;

/**
 * __useGetRtmTokenMutation__
 *
 * To run a mutation, you first call `useGetRtmTokenMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useGetRtmTokenMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [getRtmTokenMutation, { data, loading, error }] = useGetRtmTokenMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetRtmTokenMutation(
  baseOptions?: Apollo.MutationHookOptions<
    GetRtmTokenMutation,
    GetRtmTokenMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<GetRtmTokenMutation, GetRtmTokenMutationVariables>(
    GetRtmTokenDocument,
    options
  );
}
export type GetRtmTokenMutationHookResult = ReturnType<
  typeof useGetRtmTokenMutation
>;
export type GetRtmTokenMutationResult =
  Apollo.MutationResult<GetRtmTokenMutation>;
export type GetRtmTokenMutationOptions = Apollo.BaseMutationOptions<
  GetRtmTokenMutation,
  GetRtmTokenMutationVariables
>;
...
`;
export type ChangeCallStatusMutationFn = Apollo.MutationFunction<
  ChangeCallStatusMutation,
  ChangeCallStatusMutationVariables
>;

/**
 * __useChangeCallStatusMutation__
 *
 * To run a mutation, you first call `useChangeCallStatusMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useChangeCallStatusMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [changeCallStatusMutation, { data, loading, error }] = useChangeCallStatusMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useChangeCallStatusMutation(
  baseOptions?: Apollo.MutationHookOptions<
    ChangeCallStatusMutation,
    ChangeCallStatusMutationVariables
  >
  ...
  return Apollo.useMutation<
    ChangeCallStatusMutation,
    ChangeCallStatusMutationVariables
  >(ChangeCallStatusDocument, options);
}
export type ChangeCallStatusMutationHookResult = ReturnType<
  typeof useChangeCallStatusMutation
>;
export type ChangeCallStatusMutationResult =
  Apollo.MutationResult<ChangeCallStatusMutation>;
export type ChangeCallStatusMutationOptions = Apollo.BaseMutationOptions<
  ChangeCallStatusMutation,
  ChangeCallStatusMutationVariables
>;
...
`;
export type EndCallMutationFn = Apollo.MutationFunction<
  EndCallMutation,
...
`;
export type LeftCallMutationFn = Apollo.MutationFunction<
  LeftCallMutation,
  LeftCallMutationVariables
>;

/**
 * __useLeftCallMutation__
 *
 * To run a mutation, you first call `useLeftCallMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useLeftCallMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [leftCallMutation, { data, loading, error }] = useLeftCallMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useLeftCallMutation(
  baseOptions?: Apollo.MutationHookOptions<
    LeftCallMutation,
    LeftCallMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<LeftCallMutation, LeftCallMutationVariables>(
    LeftCallDocument,
    options
  );
}
export type LeftCallMutationHookResult = ReturnType<typeof useLeftCallMutation>;
export type LeftCallMutationResult = Apollo.MutationResult<LeftCallMutation>;
export type LeftCallMutationOptions = Apollo.BaseMutationOptions<
  LeftCallMutation,
  LeftCallMutationVariables
>;
...
export function useCallListQuery(
  baseOptions: Apollo.QueryHookOptions<CallListQuery, CallListQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CallListQuery, CallListQueryVariables>(
    CallListDocument,
    options
  );
}
export function useCallListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    CallListQuery,
    CallListQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<CallListQuery, CallListQueryVariables>(
    CallListDocument,
    options
  );
}
export type CallListQueryHookResult = ReturnType<typeof useCallListQuery>;
export type CallListLazyQueryHookResult = ReturnType<
  typeof useCallListLazyQuery
>;
export type CallListQueryResult = Apollo.QueryResult<
  CallListQuery,
  CallListQueryVariables
>;
export const GetCallListWithAParticipantDocument = gql`
...
/**
 * __useGetCallListWithAParticipantQuery__
 *
 * To run a query within a React component, call `useGetCallListWithAParticipantQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCallListWithAParticipantQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCallListWithAParticipantQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetCallListWithAParticipantQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetCallListWithAParticipantQuery,
    GetCallListWithAParticipantQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetCallListWithAParticipantQuery,
    GetCallListWithAParticipantQueryVariables
  >(GetCallListWithAParticipantDocument, options);
}
export function useGetCallListWithAParticipantLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetCallListWithAParticipantQuery,
    GetCallListWithAParticipantQueryVariables
  >
...
export type GetCallListWithAParticipantQueryHookResult = ReturnType<
  typeof useGetCallListWithAParticipantQuery
>;
export type GetCallListWithAParticipantLazyQueryHookResult = ReturnType<
  typeof useGetCallListWithAParticipantLazyQuery
>;
export type GetCallListWithAParticipantQueryResult = Apollo.QueryResult<
  GetCallListWithAParticipantQuery,
  GetCallListWithAParticipantQueryVariables
>;
...
`;
export type AcceptRejectVideoRequestMutationFn = Apollo.MutationFunction<
  AcceptRejectVideoRequestMutation,
  AcceptRejectVideoRequestMutationVariables
>;

/**
 * __useAcceptRejectVideoRequestMutation__
 *
 * To run a mutation, you first call `useAcceptRejectVideoRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAcceptRejectVideoRequestMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [acceptRejectVideoRequestMutation, { data, loading, error }] = useAcceptRejectVideoRequestMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAcceptRejectVideoRequestMutation(
  baseOptions?: Apollo.MutationHookOptions<
    AcceptRejectVideoRequestMutation,
    AcceptRejectVideoRequestMutationVariables
  >
  ...
  return Apollo.useMutation<
    AcceptRejectVideoRequestMutation,
    AcceptRejectVideoRequestMutationVariables
  >(AcceptRejectVideoRequestDocument, options);
}
export type AcceptRejectVideoRequestMutationHookResult = ReturnType<
  typeof useAcceptRejectVideoRequestMutation
>;
export type AcceptRejectVideoRequestMutationResult =
  Apollo.MutationResult<AcceptRejectVideoRequestMutation>;
export type AcceptRejectVideoRequestMutationOptions =
...
`;
export type RequestVideoCallMutationFn = Apollo.MutationFunction<
  RequestVideoCallMutation,
  RequestVideoCallMutationVariables
>;

/**
 * __useRequestVideoCallMutation__
 *
 * To run a mutation, you first call `useRequestVideoCallMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRequestVideoCallMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [requestVideoCallMutation, { data, loading, error }] = useRequestVideoCallMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useRequestVideoCallMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RequestVideoCallMutation,
    RequestVideoCallMutationVariables
  >
  ...
  return Apollo.useMutation<
    RequestVideoCallMutation,
    RequestVideoCallMutationVariables
  >(RequestVideoCallDocument, options);
}
export type RequestVideoCallMutationHookResult = ReturnType<
  typeof useRequestVideoCallMutation
>;
export type RequestVideoCallMutationResult =
  Apollo.MutationResult<RequestVideoCallMutation>;
export type RequestVideoCallMutationOptions = Apollo.BaseMutationOptions<
  RequestVideoCallMutation,
  RequestVideoCallMutationVariables
>;
export const CallWaitingDocument = gql`
...
`;
export type CallWaitingMutationFn = Apollo.MutationFunction<
  CallWaitingMutation,
  CallWaitingMutationVariables
>;

/**
 * __useCallWaitingMutation__
 *
 * To run a mutation, you first call `useCallWaitingMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCallWaitingMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [callWaitingMutation, { data, loading, error }] = useCallWaitingMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCallWaitingMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CallWaitingMutation,
    CallWaitingMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CallWaitingMutation, CallWaitingMutationVariables>(
    CallWaitingDocument,
    options
  );
}
export type CallWaitingMutationHookResult = ReturnType<
  typeof useCallWaitingMutation
>;
export type CallWaitingMutationResult =
  Apollo.MutationResult<CallWaitingMutation>;
export type CallWaitingMutationOptions = Apollo.BaseMutationOptions<
  CallWaitingMutation,
  CallWaitingMutationVariables
>;
export const GetParticipantsFromContactDocument = gql`
...
/**
 * __useGetParticipantsFromContactQuery__
 *
 * To run a query within a React component, call `useGetParticipantsFromContactQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetParticipantsFromContactQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetParticipantsFromContactQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetParticipantsFromContactQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetParticipantsFromContactQuery,
    GetParticipantsFromContactQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetParticipantsFromContactQuery,
    GetParticipantsFromContactQueryVariables
  >(GetParticipantsFromContactDocument, options);
}
export function useGetParticipantsFromContactLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetParticipantsFromContactQuery,
    GetParticipantsFromContactQueryVariables
  >
...
export type GetParticipantsFromContactQueryHookResult = ReturnType<
  typeof useGetParticipantsFromContactQuery
>;
export type GetParticipantsFromContactLazyQueryHookResult = ReturnType<
  typeof useGetParticipantsFromContactLazyQuery
>;
export type GetParticipantsFromContactQueryResult = Apollo.QueryResult<
  GetParticipantsFromContactQuery,
  GetParticipantsFromContactQueryVariables
>;
export const GetMyCallListDocument = gql`
...
/**
 * __useGetMyCallListQuery__
 *
 * To run a query within a React component, call `useGetMyCallListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMyCallListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMyCallListQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetMyCallListQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetMyCallListQuery,
    GetMyCallListQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetMyCallListQuery, GetMyCallListQueryVariables>(
    GetMyCallListDocument,
    options
  );
}
export function useGetMyCallListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetMyCallListQuery,
    GetMyCallListQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetMyCallListQuery, GetMyCallListQueryVariables>(
    GetMyCallListDocument,
    options
  );
}
export type GetMyCallListQueryHookResult = ReturnType<
  typeof useGetMyCallListQuery
>;
export type GetMyCallListLazyQueryHookResult = ReturnType<
  typeof useGetMyCallListLazyQuery
>;
export type GetMyCallListQueryResult = Apollo.QueryResult<
  GetMyCallListQuery,
  GetMyCallListQueryVariables
>;
...
`;
export type AddParticipantsMutationFn = Apollo.MutationFunction<
...
export function useAddParticipantsMutation(
  ...
  return Apollo.useMutation<
    AddParticipantsMutation,
    AddParticipantsMutationVariables
  >(AddParticipantsDocument, options);
}
export type AddParticipantsMutationHookResult = ReturnType<
  typeof useAddParticipantsMutation
>;
export type AddParticipantsMutationResult =
  Apollo.MutationResult<AddParticipantsMutation>;
export type AddParticipantsMutationOptions = Apollo.BaseMutationOptions<
  AddParticipantsMutation,
  AddParticipantsMutationVariables
>;
export const GetOnGoingCallsDocument = gql`
...
/**
 * __useGetOnGoingCallsQuery__
 *
 * To run a query within a React component, call `useGetOnGoingCallsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOnGoingCallsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOnGoingCallsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetOnGoingCallsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetOnGoingCallsQuery,
    GetOnGoingCallsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetOnGoingCallsQuery, GetOnGoingCallsQueryVariables>(
    GetOnGoingCallsDocument,
    options
  );
}
export function useGetOnGoingCallsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetOnGoingCallsQuery,
    GetOnGoingCallsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetOnGoingCallsQuery,
    GetOnGoingCallsQueryVariables
  >(GetOnGoingCallsDocument, options);
}
export type GetOnGoingCallsQueryHookResult = ReturnType<
  typeof useGetOnGoingCallsQuery
>;
export type GetOnGoingCallsLazyQueryHookResult = ReturnType<
  typeof useGetOnGoingCallsLazyQuery
>;
export type GetOnGoingCallsQueryResult = Apollo.QueryResult<
  GetOnGoingCallsQuery,
  GetOnGoingCallsQueryVariables
>;
export const CreateNewCallDocument = gql`
...
`;
export type CreateNewCallMutationFn = Apollo.MutationFunction<
  CreateNewCallMutation,
  CreateNewCallMutationVariables
>;

/**
 * __useCreateNewCallMutation__
 *
 * To run a mutation, you first call `useCreateNewCallMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateNewCallMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createNewCallMutation, { data, loading, error }] = useCreateNewCallMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateNewCallMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateNewCallMutation,
    CreateNewCallMutationVariables
  >
  ...
  return Apollo.useMutation<
    CreateNewCallMutation,
    CreateNewCallMutationVariables
  >(CreateNewCallDocument, options);
}
export type CreateNewCallMutationHookResult = ReturnType<
  typeof useCreateNewCallMutation
>;
export type CreateNewCallMutationResult =
  Apollo.MutationResult<CreateNewCallMutation>;
export type CreateNewCallMutationOptions = Apollo.BaseMutationOptions<
  CreateNewCallMutation,
  CreateNewCallMutationVariables
>;
export const GetJoinedOnGoingCallsDocument = gql`
...
/**
 * __useGetJoinedOnGoingCallsQuery__
 *
 * To run a query within a React component, call `useGetJoinedOnGoingCallsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetJoinedOnGoingCallsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetJoinedOnGoingCallsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetJoinedOnGoingCallsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetJoinedOnGoingCallsQuery,
    GetJoinedOnGoingCallsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetJoinedOnGoingCallsQuery,
    GetJoinedOnGoingCallsQueryVariables
  >(GetJoinedOnGoingCallsDocument, options);
}
export function useGetJoinedOnGoingCallsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetJoinedOnGoingCallsQuery,
    GetJoinedOnGoingCallsQueryVariables
  >
...
export type GetJoinedOnGoingCallsQueryHookResult = ReturnType<
  typeof useGetJoinedOnGoingCallsQuery
>;
export type GetJoinedOnGoingCallsLazyQueryHookResult = ReturnType<
  typeof useGetJoinedOnGoingCallsLazyQuery
>;
export type GetJoinedOnGoingCallsQueryResult = Apollo.QueryResult<
  GetJoinedOnGoingCallsQuery,
  GetJoinedOnGoingCallsQueryVariables
>;
export const GetChannelStatusDocument = gql`
...
/**
 * __useGetChannelStatusQuery__
 *
 * To run a query within a React component, call `useGetChannelStatusQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetChannelStatusQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetChannelStatusQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetChannelStatusQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetChannelStatusQuery,
    GetChannelStatusQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetChannelStatusQuery, GetChannelStatusQueryVariables>(
    GetChannelStatusDocument,
    options
  );
}
export function useGetChannelStatusLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetChannelStatusQuery,
    GetChannelStatusQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetChannelStatusQuery,
    GetChannelStatusQueryVariables
  >(GetChannelStatusDocument, options);
}
export type GetChannelStatusQueryHookResult = ReturnType<
  typeof useGetChannelStatusQuery
>;
export type GetChannelStatusLazyQueryHookResult = ReturnType<
  typeof useGetChannelStatusLazyQuery
>;
export type GetChannelStatusQueryResult = Apollo.QueryResult<
  GetChannelStatusQuery,
  GetChannelStatusQueryVariables
>;
