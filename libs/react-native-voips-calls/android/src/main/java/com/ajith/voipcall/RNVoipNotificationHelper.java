...
public class RNVoipNotificationHelper {
    ...
    public void sendCallNotification(ReadableMap jsonObject){
        ...
        Log.d("testR", "sendCallNotification: ");
        sendNotification(jsonObject);
    }


    public void sendNotification(ReadableMap json){
        Log.d("testR", "sendCallNotification: step 0 ");
...
//        Log.d("testR", "sendCallNotification: step 1 ");
...
//                .build();
//        Log.d("testR", "sendCallNotification: step 2 ");
//        NotificationManager notificationManager = notificationManager();
//        Log.d("testR", "sendCallNotification: step 3 ");
//        createCallNotificationChannel(notificationManager, json);
//        Log.d("testR", "sendCallNotification: step 4 ");
...
//        PendingIntent callDismissIntent = PendingIntent.getBroadcast(context,0, dissmissIntent ,PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
            ...
            // Handle the exception here, e.g., log the error or perform some fallback action.
            Log.e("testR", "Error while building the notification: " + e.getMessage());
        }
    }
